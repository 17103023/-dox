...
//	
	...
	public String toString() {
		return " "+tableNumber;//Order [tableNumber=" + tableNumber+"]";// + ", orderedMenu=" + orderedMenu + ", menuPrice=" + menuPrice
				//+ ", orderedNumber=" + orderedNumber + ", totalPrice=" + menuPrice*orderedNumber +",average person's money per table="+menuPrice/orderedNumber+"]";
	}
