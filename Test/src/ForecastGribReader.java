...
public class ForecastGribReader  {
	...
	public static void main(String args[]){
		...
		try {
			...
			String forecastApiBaseUri = "http://api.map.baidu.com/telematics/v3/weather?location=/ForecastGrib";
			...
			builder.addParameter("base_date", "20180721");
			builder.addParameter("base_time", "0001");
